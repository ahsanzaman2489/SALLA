...
describe('cart-layout-header', () => {
  it('renders no divider and back component when loading true', async () => {
    ...
    expect(page.root).toEqualHtml(`
     <div class="cart-header"><div class="flex flex-row items-center"><div class="cart-header-logo"><img src="hello" alt="logo"></div><div class="ml-4"><div class="cart-header-store-name color-primary text-left">Sample Store</div><p class="cart-header-breadcrumbs"><span> <span class="underline cursor-pointer color-secondary-lite">store</span><span class="color-secondary-lite"> /</span> </span><span> <span class="underline cursor-pointer color-secondary-lite">cart</span><span class="color-secondary-lite"> /</span> </span><span> <span class="cart-header-current color-secondary">checkout</span> </span></p></div></div><div class="cart-header-divider my-5"></div></div>
    `);
  });

  it('renders divider and back component when loading false', async () => {
